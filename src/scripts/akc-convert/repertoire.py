...
class Repertoire(Parser):
    ...
    def getAIRRUniqueLink2(self, repertoire_dict, link_class, akc_class):
    ...
    def generateAKCInvestigation(self, repertoire_dict, investigation_dict, akc_class_list):
        ...
        #print(akc_ref_fields['akc_class'])
        #print(akc_ref_fields['akc_form'])
        #print(akc_ref_fields['akc_field'])
        #print(akc_ref_fields['akc_type'])
        ...
        for akc_class in akc_class_list:
            ...
            for key, value in repertoire_dict.items():
                ...
                if 'akc_class' in value and value['akc_class'] == akc_class:
                    ...
                    #akc_object['adc_' + value['akc_field'] + '_' + str(value['akc_type']) + '_' + str(value['akc_class'])] = 'foo' 
                    ...
                    if value['akc_form'] == "Class": 
                        ...
                        if class_link_value in akc_class_dict:
                            ...
                            #akc_class_object['adc_study_group_description'] = study_group_description
