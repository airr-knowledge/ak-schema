...
--     * Slot: type Description: 
--     * Slot: akc_id Description: A unique identifier for a thing in the AKC.
-- # Class: "AIRRSequenceAnnotationData" Description: "annotated VDJ sequence data"
--     * Slot: type Description: 
--     * Slot: akc_id Description: A unique identifier for a thing in the AKC.
-- # Class: "AIRRGenotypeData" Description: ""
...
--     * Slot: akc_id Description: A unique identifier for a thing in the AKC.
--     * Slot: paired_chain Description: Flag to indicate the receptor object has both chains defined
-- # Class: "AlphaBetaReceptorComposite" Description: ""
--     * Slot: species Description: Binomial designation of subject's species
--     * Slot: tcr_complex Description: TCR complex
--     * Slot: antigen Description: A material entity with antigen role
--     * Slot: epitope Description: Epitope of an antigen, which can be recognized by a T cell receptor or antibody
...
--     * Slot: akc_id Description: A unique identifier for a thing in the AKC.
--     * Slot: paired_chain Description: Flag to indicate the receptor object has both chains defined
-- # Class: "GammaDeltaReceptorComposite" Description: ""
--     * Slot: species Description: Binomial designation of subject's species
--     * Slot: tcr_complex Description: TCR complex
--     * Slot: antigen Description: A material entity with antigen role
--     * Slot: epitope Description: Epitope of an antigen, which can be recognized by a T cell receptor or antibody
...
--     * Slot: akc_id Description: A unique identifier for a thing in the AKC.
--     * Slot: paired_chain Description: Flag to indicate the receptor object has both chains defined
-- # Class: "BCellReceptorComposite" Description: ""
--     * Slot: species Description: Binomial designation of subject's species
--     * Slot: antibody_complex Description: Antibody antigen complex
--     * Slot: antigen Description: A material entity with antigen role
--     * Slot: epitope Description: Epitope of an antigen, which can be recognized by a T cell receptor or antibody
...
--     * Slot: data_item_types Description: semantic types of the data
-- # Class: "AIRRSequenceAnnotationData_data_item_types" Description: ""
--     * Slot: AIRRSequenceAnnotationData_akc_id Description: Autocreated FK slot
--     * Slot: data_item_types Description: semantic types of the data
-- # Class: "AIRRGenotypeData_genotype_class_list" Description: ""
--     * Slot: AIRRGenotypeData_akc_id Description: Autocreated FK slot
--     * Slot: genotype_class_list_id Description: List of Genotypes included in this Receptor Genotype Set.
-- # Class: "AIRRGenotypeData_data_item_types" Description: ""
--     * Slot: AIRRGenotypeData_akc_id Description: Autocreated FK slot
--     * Slot: data_item_types Description: semantic types of the data
...
--     * Slot: mhc_alleles_allele_designation Description: List of MHC alleles of the indicated mhc_class identified in an individual
...
CREATE TABLE "DataTransformation_data_transformation_types" (
	...
	data_transformation_types VARCHAR(25), 
