# Contributing to ak-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
ak-schema. These guidelines are not strict rules.
...
The ak-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the ak-schema technical leads
...
[issues]: https://github.com/airr-knowledge/ak-schema/issues/
[pulls]: https://github.com/airr-knowledge/ak-schema/pulls/
